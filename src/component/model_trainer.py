...
from src.util.util import load_numpy_array_data,save_object,load_object
...
Model_training_status = namedtuple("Model_training_status", ["training_status"])
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            self.model_training_status = True #true, as the model training is started
            ...
            housing_model = spamhamDetectionModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            ...
            self.model_training_status = False  #as training completed
            print("trainer set to false")
            print("model trained")
    ...
    @model_training_status.setter
    def model_training_status(self, status: bool):
